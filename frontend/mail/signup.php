                                    ...
                                    <table cellpadding="0" cellspacing="0" class="force-full-width">
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                                    <tr>
                                                        <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                                                            <h1>Chào mừng đến với Trung tâm môi giới nông sản Việt Nam</h1>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                            <b> Chào <?= $data->fullname ?>, cảm ơn vì đã đăng ký! </b><br>
                                                                Chúng tôi rất vui vì bạn tham gia cộng đồng của chúng tôi! Bạn chỉ cần một cú nhấp chuột để kích hoạt tài khoản của bạn.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                                    ...
                                                                    <td style="width:200px;background:#008000;">
                                                                        <div><!--[if mso]>
                                                                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:200px;" stroke="f" fillcolor="#008000">
                                                                            ...
                                                                            <center>
                                                                          <![endif]-->
                                                                            <a href="<?= \Yii::$app->urlManager->createAbsoluteUrl(['user/active', 'auth' => $data->auth_key]) ?>"
                                                                               style="background-color:#008000;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Kích hoạt tài khoản</a>
                                                                            <!--[if mso]>
                                                                              </center>
                                                                            </v:rect>
                                                                          <![endif]--></div>
                                        ...
                                        <tr>
                                            <td valign="top" class="footer-cell">
                                                Trung tâm môi giới nông sản Việt Nam
                                            </td>
                                        </tr>
                                    </table>
                                </td>
