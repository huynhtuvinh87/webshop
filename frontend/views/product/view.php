                        ...
                        <div class="col-md-7 col-right">
                            ...
                            <div class="rating">
                                ...
                                if ($model->countReview > 0) {
                                    ...
                                    <a class="count-review" href="javascript:void(0)">(<?= $model->countReview ?> đánh giá)</a>
                            ...
                            <div class="button-group">
                                <div class="item item-buy">
                                    <div class="item-wrap">
                                        <button type="button" name="buynow" class="btn btn-buy buynow"><i class="fa fa-envelope" aria-hidden="true"></i>Mua ngay</button>
                                        <p>Mua trực tiếp từ nhà bán</p>
                                    </div>
                                </div>
                                <div class="item item-sms">
                                    <div class="item-wrap"> <a href="/message/view/<?= $model->id ?>" class="btn request"><i class="fa fa-envelope" aria-hidden="true"></i> Nhắn tin</a>
                                        <p>Trao đổi trực tiếp với nhà bán</p>
                                    </div>
                                </div>
                            </div>

                            <ul class="list-button">
                                <li><a href="javascript:void(0)" class="addcart"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Thêm vào giỏ hàng <small></small></a></li>
                                <?php
                                if ($quantity_purchase_total > 0) {
                                    ?>
                                    <li>
                                        <?= $quantity_purchase_total ?> <?= $model->unit ?> đã được mua
                                    </li>
                                    <?php
                                }
                                ?>
                    ...
                    <div class="sb-content">
                        ...
                        <div class="rating">
                            ...
                            if ($seller->getCountReview() > 0) {
                                ...
                                <small><a href="/nha-vuon/<?= $seller->getUsername() ?>?type=review">( <?= $seller->getCountReview() ?> đánh giá )</a></small>
                                <?php
                            }
                            ?>
                        </div>
